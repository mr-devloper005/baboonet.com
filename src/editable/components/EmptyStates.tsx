...
export function EmptyState({
  ...
  return (
    <section className={cn('rounded-[2rem] border border-black/10 bg-white p-8 text-center shadow-[0_18px_45px_rgba(0,0,0,0.06)]', className)}>
      <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-[var(--slot4-warm)]">
      ...
      <Link href={actionHref} className="mt-6 inline-flex items-center gap-2 rounded-full bg-black px-5 py-3 text-sm font-black uppercase tracking-[0.16em] text-white transition hover:-translate-y-0.5">
        {actionLabel}
